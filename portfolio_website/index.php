    ...
    <div class="container">
      ...
      <div class="contact-grid">
        ...
        <div class="contact-pane">
                    <?php if (isset($_SESSION['contact_flash'])):
             $ok  = !empty($_SESSION['contact_flash']['ok']);
             $msg = (string)($_SESSION['contact_flash']['msg'] ?? '');
             unset($_SESSION['contact_flash']); // one-time: consume and remove
           ?>
          ...
          <?php if (!empty($_SESSION['role']) && $_SESSION['role'] === 'ADMIN'): ?>
            ...
            <div class="contact-admin-note">
              <p><strong>Admins</strong> can view or delete messages in the
                ...
                Submitting this form is disabled for Admin accounts.
              </p>
            </div>
          ...
          <?php else: ?>
            <!-- USER (guest/non-admin): real, working form -->
